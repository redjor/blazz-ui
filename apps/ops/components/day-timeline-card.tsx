...
const KIND_STYLES: Record<TimelineItemKind, string> = {
	...
	personal: "border-edge bg-raised text-fg-muted",
	uncategorized: "border-edge bg-raised text-fg-muted",
}
							...
							return (
								<li key={item.id}>
									<button
										...
										className="flex w-full items-start justify-between gap-3 px-inset py-3 text-left transition-colors hover:bg-raised/60"
									>
										{content}
									</button>
								</li>
