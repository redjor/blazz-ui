		...
		<form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
			...
			<div className="flex items-center gap-4">
				<button
					...
					disabled={uploading}
					className="relative size-16 rounded-lg border-2 border-dashed border-edge bg-card hover:bg-muted transition-colors flex items-center justify-center overflow-hidden shrink-0 cursor-pointer"
				>
					{uploading ? (
