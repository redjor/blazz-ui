...
const categoryDescriptions: Record<string, string> = {
	...
	"block-metrics": "KPI grids, stats strips, budget cards and progress indicators.",
	"block-detail-views": "Detail panels, property cards, inline editing and split views.",
	"block-workflow": "Kanban boards, status flows and multi-step forms.",
	"block-feeds": "Activity timelines, inbox, notifications and quick log.",
	"block-commerce": "Deal lines editor and quote preview.",
	"block-settings": "Org menu and settings blocks.",
...
export const componentsNavigation: ComponentNavCategory[] = sidebarConfig.navigation
	.filter((section) => section.id === "components")
