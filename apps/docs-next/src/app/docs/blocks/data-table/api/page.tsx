...
const propGroups: DocPropGroup[] = [
	{
		...
		props: [
			{ name: "data", type: "TData[]", required: true, description: "Array of row data" },
			{
				...
				required: true,
				description: "Column definitions — use col.* factories",
			},
	...
	},
	{
		...
		props: [
			...
			},
			{
				...
				type: "boolean",
				default: "false",
				description: "Allow multi-column sort",
			},
			{
			...
			},
			{
				...
				type: "boolean",
				default: "false",
				description: "Enable row checkboxes",
			},
			{
			...
			},
			{
				...
				type: "boolean",
				default: "false",
				description: "Enable filter builder",
			},
			{
				name: "enableCustomViews",
				type: "boolean",
				default: "false",
				description: "Allow creating/saving views",
			},
			{
				name: "enableGrouping",
				type: "boolean",
			...
			},
			{
				...
				type: "boolean",
				default: "false",
				description: "Enable sticky columns",
			},
			{
	...
	},
	{
		...
		props: [
			{
				name: "variant",
				type: '"default" | "lined" | "striped" | "flat" | "editable" | "spreadsheet"',
				default: '"lined"',
			...
			},
			{
				...
				default: '"classic"',
				description: "Toolbar layout mode",
			},
			{
				name: "hideToolbar",
				type: "boolean",
			...
			},
			{
				...
				type: "boolean",
				default: "false",
				description: "Hide column headers (automatic in flat variant)",
			},
	...
	},
	{
		...
		props: [
			...
			},
			{
				...
				type: "(row: Row<TData>) => ReactNode",
				description: "Content for expanded row panel",
			},
			{
				name: "renderGroupHeader",
				type: "(row: Row<TData>, defaultContent: ReactNode) => ReactNode",
				description: "Full replacement of group header row",
			},
			{
				name: "renderGroupHeaderContent",
				type: "(info: { row, groupValue, subRowCount, aggregations }) => ReactNode",
				description: "Replace only central content of group header",
			},
			{
				name: "renderRowActions",
				type: "(row: Row<TData>) => ReactNode",
				description: "Replace the ... dropdown with custom actions",
			},
			{
				name: "renderPagination",
				type: "(info: PaginationInfo) => ReactNode",
				description: "Replace default pagination with custom UI",
			},
			{
				name: "groupRowStyle",
				type: "(row: Row<TData>) => CSSProperties",
				description: "Inline styles for group header cells",
			},
			{
				name: "toolbarLeadingSlot",
				type: "ReactNode",
				description: "Content before view pills in toolbar",
			},
			{
				name: "toolbarTrailingSlot",
				type: "ReactNode",
				description: "Content after icon actions in toolbar",
			},
			{
				name: "toolbarBelowSlot",
				type: "ReactNode",
				description: "Content between toolbar and table",
			},
		...
		props: [
			{
				...
				description: "Dropdown menu actions per row",
			},
			{
				name: "bulkActions",
				type: "BulkAction<TData>[]",
				description: "Actions when rows are selected",
			},
	...
	},
	{
		...
		props: [
			...
			},
			{
				...
				description: "Called when grouping changes",
			},
			{
				name: "onSearchChange",
				type: "(search: string) => void",
				description: "Called when search changes (server-side)",
			},
			{
				name: "onCellEdit",
				type: "(rowId, columnId, value, previousValue) => void",
				description: "Called when a cell is edited",
			},
			{
				name: "onFilterGroupChange",
				type: "(filterGroup) => void",
				description: "Called when advanced filter changes",
			},
		],
	},
]
