      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            { title: "Color Picker", url: "/docs/components/ui/color-picker" },
            { title: "Combobox", url: "/docs/components/ui/combobox" },
            { title: "Currency Input", url: "/docs/components/ui/currency-input" },
            { title: "Date Selector", url: "/docs/components/ui/date-selector" },
            { title: "File Upload", url: "/docs/components/ui/file-upload" },
            { title: "Input", url: "/docs/components/ui/input" },
            { title: "Label", url: "/docs/components/ui/label" },
            { title: "Number Input", url: "/docs/components/ui/number-input" },
            { title: "OTP Input", url: "/docs/components/ui/otp-input" },
            { title: "Password Input", url: "/docs/components/ui/password-input" },
            { title: "Phone Input", url: "/docs/components/ui/phone-input" },
            { title: "Radio Group", url: "/docs/components/ui/radio-group" },
            { title: "Rating", url: "/docs/components/ui/rating" },
            { title: "Search Input", url: "/docs/components/ui/search-input" },
            { title: "Select", url: "/docs/components/ui/select" },
            { title: "Slider", url: "/docs/components/ui/slider" },
            { title: "Switch", url: "/docs/components/ui/switch" },
            { title: "Tags Input", url: "/docs/components/ui/tags-input" },
            { title: "Textarea", url: "/docs/components/ui/textarea" },
            { title: "Time Picker", url: "/docs/components/ui/time-picker" },
          ],
        },
        {
          id: "comp-feedback",
        ...
        },
        {
          ...
          items: [
            ...
            { title: "Pagination", url: "/docs/components/ui/pagination" },
            { title: "Stepper", url: "/docs/components/ui/stepper" },
        ...
        },
        {
          ...
          items: [
            ...
            { title: "Timeline", url: "/docs/components/ui/timeline" },
            { title: "Tree View", url: "/docs/components/ui/tree-view" },
          ],
        },
        {
          id: "comp-foundations",
