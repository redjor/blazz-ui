...
<div className="-mx-inset -mt-inset p-inset bg-muted">
	...
	return (
		...
		>
			...
			<DocSection id="bleed-pattern" title="Pattern Bleed">
				...
				>
					<div className="max-w-sm rounded-xl border border-container bg-card overflow-hidden">
						<div className="p-[var(--inset)]">
							{/* Simulated dialog header */}
							<div className="mx-[calc(-1*var(--inset))] mt-[calc(-1*var(--inset))] p-[var(--inset)] border-b border-separator bg-muted/50">
					...
					<table className="w-full text-sm">
						...
						<tbody className="divide-y divide-separator">
							{[
								...
								{
									cls: "-mx-inset",
									css: "margin-inline: calc(-1 * var(--inset))",
									usage: "Bleed horizontal",
								},
								{
									cls: "-mt-inset",
									css: "margin-top: calc(-1 * var(--inset))",
									usage: "Bleed en haut",
								},
								{
									cls: "-mb-inset",
									css: "margin-bottom: calc(-1 * var(--inset))",
									usage: "Bleed en bas",
								},
							].map((row) => (
								<tr key={row.cls}>
					...
					<table className="w-full text-sm">
						...
						<tbody className="divide-y divide-separator">
							{[
								...
								{ comp: "SheetHeader", cls: "px-inset + calc(x 0.75)", pattern: "Asymétrique" },
								{ comp: "SheetFooter", cls: "px-inset + calc(x 0.75)", pattern: "Asymétrique" },
								{ comp: "HoverCardContent", cls: "p-inset", pattern: "Container" },
								{ comp: "Alert", cls: "px-inset + calc(x 0.5)", pattern: "Asymétrique" },
							].map((row) => (
								<tr key={row.comp}>
									<td className="px-4 py-2">
