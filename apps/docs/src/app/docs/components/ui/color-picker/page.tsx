...
export default function ColorPickerPage() {
	...
	return (
		<DocPage title="ColorPicker" subtitle="A popover-based color picker with preset swatches and a custom color input. Supports hex values and native color input." toc={toc}>
			<DocHero>
				<ColorPicker />
			</DocHero>

			<DocSection id="examples" title="Examples">
				<DocExampleClient title="Default" description="A basic color picker with default presets." code={examples[0].code} highlightedCode={html("default")}>
					<ColorPicker />
				</DocExampleClient>

				<DocExampleClient title="With Value" description="Pre-select a color value." code={examples[1].code} highlightedCode={html("with-value")}>
					<ColorPicker value="#3b82f6" />
				</DocExampleClient>

				<DocExampleClient title="Custom Presets" description="Provide a custom set of preset colors." code={examples[2].code} highlightedCode={html("custom-presets")}>
					<ColorPicker presets={["#ef4444", "#f97316", "#eab308", "#22c55e", "#3b82f6", "#8b5cf6"]} />
				</DocExampleClient>

				<DocExampleClient title="Controlled" description="Manage the selected color with state." code={examples[3].code} highlightedCode={html("controlled")}>
					<ControlledColorPickerDemo />
				</DocExampleClient>

				<DocExampleClient title="Disabled" description="Disabled color pickers prevent interaction." code={examples[4].code} highlightedCode={html("disabled")}>
