	...
	return (
		...
		>
			...
			<DocSection id="related" title="Related">
				<DocRelated
					items={[
						{ title: "Data Table", href: "/docs/components/ui/data-table", description: "The full DataTable component that uses these cell types via the col.* namespace." },
						{ title: "Badge", href: "/docs/components/ui/badge", description: "The Badge primitive used by CellTags, CellBoolean, and CellValidation." },
						{ title: "Avatar", href: "/docs/components/ui/avatar", description: "The Avatar primitive used by CellUser and CellAvatarGroup." },
					]}
				/>
			</DocSection>
		</DocPage>
