...
const mockSuggestions = ["Quels outils de profiling utiliser ?", "Comment optimiser les images ?", "Parle-moi de React Server Components"]
...
export default function ConversationPage() {
	return (
		<DocPage title="Conversation" subtitle="A complete chat interface combining messages, reasoning, sources, suggestions, and prompt input into a cohesive conversational experience." toc={toc}>
						...
						<ConversationContent className="gap-6 p-6">
							...
							<Message from="assistant">
								<Reasoning defaultOpen={false} duration={12}>
									<ReasoningTrigger />
									<ReasoningContent>
										L'utilisateur demande des conseils sur les performances React. Je vais couvrir la memoisation, le code splitting et la virtualisation car ce sont les trois leviers les plus
										impactants pour une application React standard.
									</ReasoningContent>
								</Reasoning>
								<MessageContent>
									<div className="space-y-3">
										...
										<p>
											Utilisez <code className="rounded bg-muted px-1.5 py-0.5 text-xs">React.memo()</code> pour eviter les re-renders inutiles.
										</p>
										<p>
											<strong>2. Code splitting</strong>
										</p>
										<p>
											Divisez votre bundle avec <code className="rounded bg-muted px-1.5 py-0.5 text-xs">React.lazy()</code> et <code className="rounded bg-muted px-1.5 py-0.5 text-xs">Suspense</code>
											.
										</p>
										<p>
										...
										<p>
											Pour les longues listes, utilisez <code className="rounded bg-muted px-1.5 py-0.5 text-xs">react-window</code> ou{" "}
											<code className="rounded bg-muted px-1.5 py-0.5 text-xs">@tanstack/virtual</code>.
										</p>
									</div>
								</MessageContent>
							</Message>
								...
								<MessageContent>
									<div className="space-y-3">
										...
										<ul className="list-inside list-disc space-y-1">
											<li>
												<strong>Etat local</strong> : <code className="rounded bg-muted px-1.5 py-0.5 text-xs">useState</code> +{" "}
												<code className="rounded bg-muted px-1.5 py-0.5 text-xs">useReducer</code>
											</li>
											<li>
											...
											<li>
												<strong>Etat URL</strong> : <code className="rounded bg-muted px-1.5 py-0.5 text-xs">nuqs</code>
											</li>
										</ul>
									</div>
								</MessageContent>
