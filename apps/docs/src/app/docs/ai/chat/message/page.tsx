...
import { Message, MessageAction, MessageActions, MessageContent } from "@blazz/pro/components/ai/chat/message"
...
export default function MessagePage() {
	...
	return (
		<DocPage title="Message" subtitle="Displays a single chat message from a user or assistant with support for actions and branching." toc={toc}>
			<DocHero>
			...
			<DocSection id="examples" title="Examples">
				<DocExampleClient title="User Message" description="Messages from the user are aligned to the right with a subtle background." code={examples[0].code} highlightedCode={html("user-message")}>
				...
				<DocExampleClient title="Assistant Message" description="Messages from the assistant are aligned to the left." code={examples[1].code} highlightedCode={html("assistant-message")}>
					<div className="flex flex-col gap-4">
						<Message from="assistant">
							<MessageContent>
				...
				<DocExampleClient title="With Actions" description="Add action buttons below the message for copy, feedback, or regeneration." code={examples[2].code} highlightedCode={html("with-actions")}>
					<div className="flex flex-col gap-4">
						<Message from="assistant">
							<MessageContent>Here is an example of an assistant message with action buttons attached below.</MessageContent>
							<MessageActions>
								<MessageAction tooltip="Copy">
									<CopyIcon className="size-3.5" />
								</MessageAction>
