...
export default function ChainOfThoughtPage() {
	...
	return (
		<DocPage title="Chain of Thought" subtitle="A step-by-step visualization of the AI reasoning process with collapsible header and status indicators for each step." toc={toc}>
			<DocHero>
				<div className="w-full max-w-lg">
					<ChainOfThought defaultOpen>
						<ChainOfThoughtHeader>Reasoning steps</ChainOfThoughtHeader>
						<ChainOfThoughtContent>
							<ChainOfThoughtStep icon={SearchIcon} label="Searching documentation" description="Found 3 relevant articles" status="complete">
								<ChainOfThoughtSearchResults>
							...
							<ChainOfThoughtStep icon={DatabaseIcon} label="Querying knowledge base" status="complete" />
							<ChainOfThoughtStep icon={CodeIcon} label="Generating code examples" status="active" />
							<ChainOfThoughtStep icon={CheckCircleIcon} label="Formatting response" status="pending" />
						</ChainOfThoughtContent>
					</ChainOfThought>
				</div>
			</DocHero>
			...
			<DocSection id="examples" title="Examples">
				<DocExampleClient title="Step Statuses" description="Each step can be complete, active, or pending to show progress." code={examples[0].code} highlightedCode={html("step-statuses")}>
					<ChainOfThought defaultOpen>
						<ChainOfThoughtHeader>Processing</ChainOfThoughtHeader>
						<ChainOfThoughtContent>
							<ChainOfThoughtStep label="Analyzing input" description="Parsed user query successfully" status="complete" />
				...
				<DocExampleClient title="With Search Results" description="Steps can include nested search result badges." code={examples[1].code} highlightedCode={html("with-search-results")}>
					<ChainOfThought defaultOpen>
						<ChainOfThoughtHeader>Research</ChainOfThoughtHeader>
						<ChainOfThoughtContent>
							<ChainOfThoughtStep icon={SearchIcon} label="Searching the web" description="Found 4 relevant sources" status="complete">
								<ChainOfThoughtSearchResults>
				...
				<DocExampleClient title="Collapsed" description="The chain of thought can be collapsed by default." code={examples[2].code} highlightedCode={html("collapsed")}>
