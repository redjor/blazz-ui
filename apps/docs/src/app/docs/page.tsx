...
import { ArrowRight, Blocks, Box, Cpu, Eye, Layers, LayoutGrid, Puzzle, Sparkles, Zap } from "lucide-react"
		...
		<Page>
			...
			<div className="relative -mx-6 -mt-6 overflow-hidden rounded-b-2xl border-b border-edge bg-muted/40 bg-cover bg-center px-6 py-16 text-center">
				...
				<div className="relative z-10 mx-auto max-w-2xl space-y-3">
					...
					<p className="text-base text-fg-muted">A React component kit for shipping serious business apps. CRM, ATS, inventory, internal tools — the parts teams usually build from scratch.</p>
				</div>
			</div>
			...
			<div className="space-y-12 py-10">
				...
				<section className="space-y-3">
					...
					<div className="space-y-2 pl-11 text-sm leading-relaxed text-fg-secondary">
						<p>Every component follows three principles: composition over configuration, information density without clutter, and AI-native from day one.</p>
						<div className="grid gap-3 pt-1 sm:grid-cols-3">
							<div className="space-y-1 rounded-lg border border-edge bg-card px-3.5 py-2.5">
								...
								<p className="text-xs text-fg-muted">Small, focused components that combine freely. No monolithic props APIs.</p>
							</div>
							<div className="space-y-1 rounded-lg border border-edge bg-card px-3.5 py-2.5">
								<div className="flex items-center gap-2">
								...
								<p className="text-xs text-fg-muted">13px tables, 32px inputs, 40px rows. Enterprise-grade information density.</p>
							</div>
							<div className="space-y-1 rounded-lg border border-edge bg-card px-3.5 py-2.5">
								<div className="flex items-center gap-2">
								...
								<p className="text-xs text-fg-muted">MCP server, structured docs, and 52 generative UI components.</p>
							</div>
						</div>
					</div>
				</section>
				...
				<section className="space-y-3">
					...
					<div className="space-y-2 pl-11 text-sm leading-relaxed text-fg-secondary">
						<p>Built on Base UI for headless accessibility, Tailwind v4 for styling, and 25 oklch design tokens for theming. Three layers stack to cover any use case:</p>
						<div className="grid gap-x-6 gap-y-3 pt-1 sm:grid-cols-3">
							<div className="space-y-0.5">
								...
								<p className="text-xs text-fg-muted">Primitives — buttons, inputs, dialogs, cards, and layout components.</p>
							</div>
							<div className="space-y-0.5">
								<span className="text-2xl font-semibold text-fg tabular-nums">38+</span>
								<p className="text-xs text-fg-muted">Blocks — data tables, kanban boards, charts, stats grids, and pipelines.</p>
							</div>
							<div className="space-y-0.5">
								<span className="text-2xl font-semibold text-fg tabular-nums">52+</span>
								<p className="text-xs text-fg-muted">AI components — chat interfaces, reasoning, entity cards, and workflows.</p>
							</div>
						</div>
						<p className="pt-1">Three full demo apps (CRM, ATS, inventory) show every component in a real context you can fork and adapt.</p>
					</div>
				</section>
				...
				<section className="space-y-3 border-t border-edge pt-8">
					...
					<div className="grid gap-2 sm:grid-cols-2">
						{sections.map((section) => (
							<Link key={section.id} href={section.href} className="group flex items-center gap-3 rounded-lg border border-edge bg-card px-3.5 py-3 transition-colors hover:bg-muted">
								<div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-muted border border-edge">
