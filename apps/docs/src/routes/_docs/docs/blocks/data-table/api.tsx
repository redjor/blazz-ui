...
const propGroups: DocPropGroup[] = [
	{
		...
		props: [
			...
			{ name: "locale", type: '"fr" | "en"', defaultValue: '"fr"', description: "Internationalization locale" },
		],
	},
	{
		title: "Feature Flags",
		props: [
			...
			{ name: "enableMultiSort", type: "boolean", defaultValue: "false", description: "Allow multi-column sort" },
			{ name: "enablePagination", type: "boolean", defaultValue: "true", description: "Enable pagination" },
			{ name: "enableRowSelection", type: "boolean", defaultValue: "false", description: "Enable row checkboxes" },
			{ name: "enableGlobalSearch", type: "boolean", defaultValue: "true", description: "Enable search input" },
			{ name: "enableAdvancedFilters", type: "boolean", defaultValue: "false", description: "Enable filter builder" },
			{ name: "enableCustomViews", type: "boolean", defaultValue: "false", description: "Allow creating/saving views" },
			{ name: "enableGrouping", type: "boolean", defaultValue: "false", description: "Enable row grouping" },
			{ name: "enableRowExpand", type: "boolean", defaultValue: "false", description: "Enable row expansion" },
			{ name: "enableColumnPinning", type: "boolean", defaultValue: "false", description: "Enable sticky columns" },
			{ name: "enableCellEditing", type: "boolean", defaultValue: "false", description: "Enable inline cell editing" },
		],
	},
	{
		title: "Styling",
		props: [
			{ name: "variant", type: '"default" | "lined" | "striped" | "flat" | "editable" | "spreadsheet"', defaultValue: '"lined"', description: "Visual variant" },
			{ name: "density", type: '"compact" | "default" | "comfortable"', defaultValue: '"default"', description: "Row density" },
			{ name: "toolbarLayout", type: '"classic" | "stacked"', defaultValue: '"classic"', description: "Toolbar layout mode" },
			{ name: "hideToolbar", type: "boolean", defaultValue: "false", description: "Hide the toolbar entirely" },
			{ name: "hideHeaders", type: "boolean", defaultValue: "false", description: "Hide column headers (automatic in flat variant)" },
