...
export const Route = createFileRoute("/_docs/docs/components/ui/banner")({
	loader: async () => {
...
function InfoBannerDemo() {
	...
	return show ? (
		<Banner tone="info" title="Update Available" onDismiss={() => setShow(false)}>
			A new version of the app is available. Update to get the latest features.
		</Banner>
	) : (
...
function SuccessBannerDemo() {
	const [show, setShow] = React.useState(true)
	return show ? (
		<Banner tone="success" title="Changes Saved" onDismiss={() => setShow(false)}>
			Your settings have been saved successfully.
		</Banner>
	) : (
...
function WarningBannerDemo() {
	const [show, setShow] = React.useState(true)
	return show ? (
		<Banner tone="warning" title="Limited Functionality" onDismiss={() => setShow(false)}>
			Some features are temporarily unavailable due to maintenance.
		</Banner>
	) : (
...
function CriticalBannerDemo() {
	const [show, setShow] = React.useState(true)
	return show ? (
		<Banner tone="critical" title="Payment Failed" onDismiss={() => setShow(false)}>
			Your payment could not be processed. Please update your payment method.
		</Banner>
	) : (
...
function WithActionsBannerDemo() {
	return (
		<Banner
			tone="info"
			title="New Features Available"
...
function AsyncActionBannerDemo() {
