...
const commerce: ComponentDataLite[] = [
	...
	},
	{
		...
		useCase:
			"Show pricing plans or subscription options in AI responses.",
		canonicalExample:
...
const content: ComponentDataLite[] = [
	{
		...
		useCase:
			"Display file information with download action in AI responses.",
		canonicalExample:
	...
	},
	{
		...
		useCase:
			"Present summarized content or key takeaways in AI responses.",
		canonicalExample:
...
const data: ComponentDataLite[] = [
	...
	},
	{
		...
		useCase:
			"Display composite scores with breakdowns in AI responses.",
		canonicalExample:
...
const entities: ComponentDataLite[] = [
	{
		...
		useCase:
			"Display candidate profiles in AI recruitment responses.",
		canonicalExample:
	...
	},
	{
		...
		useCase:
			"Display deal pipeline information in AI sales responses.",
		canonicalExample:
...
const planning: ComponentDataLite[] = [
	...
	},
	{
		...
		useCase:
			"Display calendar overview in AI scheduling responses.",
		canonicalExample:
	...
	},
	{
		...
		useCase:
			"Display event details in AI scheduling responses.",
		canonicalExample:
	...
	},
	{
		...
		useCase:
			"Display status transitions in AI workflow responses.",
		canonicalExample:
...
const workflow: ComponentDataLite[] = [
	...
	},
	{
		...
		useCase:
			"Display approval requests in AI workflow responses.",
		canonicalExample:
	...
	},
	{
		...
		useCase:
			"Preview email content in AI communication responses.",
		canonicalExample:
	...
	},
	{
		...
		useCase:
			"Preview messages across platforms in AI responses.",
		canonicalExample:
	...
	},
	{
		...
		useCase:
			"Display task information in AI project management responses.",
		canonicalExample:
