...
import { createDealsPreset } from "@/components/data-table-presets"
...
import { type Deal, formatCurrency, deals as initialDeals } from "@/lib/sample-data"
					...
					renderColumnHeader={(column, items) => {
						...
						return (
							<div className="flex items-center justify-between border-b p-3">
								...
								<span className="text-xs text-fg-muted">{formatCurrency(stageTotal)}</span>
							</div>
						)
					}}
				/>
