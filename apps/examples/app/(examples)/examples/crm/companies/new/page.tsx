...
import { FormField } from "@blazz/ui/components/blocks/form-field"
import { FieldGrid } from "@blazz/ui/components/blocks/field-grid"
...
export default function NewCompanyPage() {
	...
	const onSubmit = async (data: CompanyFormData) => {
		...
		router.push("/examples/crm/companies")
	}
		...
		<div className="p-6 space-y-6">
			<PageHeader
				...
				breadcrumbs={[
					...
					{ label: "Entreprises", href: "/examples/crm/companies" },
					{ label: "Nouvelle" },
				]}
			/>
