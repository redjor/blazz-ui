...
export function QuickAccountListItem({ account, onSelect }: QuickAccountListItemProps) {
	...
	return (
		<button
			type="button"
			onClick={onSelect}
			className="w-full flex items-center gap-2.5 px-3 py-2 border-b border-separator/50 transition-colors hover:bg-muted focus:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-inset"
