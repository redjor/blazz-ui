...
const MessageContentBase = ({ children, className, ...props }: MessageContentProps) => (
	<div
		className={cn(
...
const MessageActionsBase = ({ className, children, ...props }: MessageActionsProps) => (
...
const MessageBranchContentBase = ({ children, ...props }: MessageBranchContentProps) => {
...
const MessageBranchSelectorBase = ({ className, ...props }: MessageBranchSelectorProps) => {
...
const MessageBranchPreviousBase = ({ children, ...props }: MessageBranchPreviousProps) => {
...
const MessageBranchNextBase = ({ children, ...props }: MessageBranchNextProps) => {
...
const MessageBranchPageBase = ({ className, ...props }: MessageBranchPageProps) => {
...
const MessageToolbarBase = ({ className, children, ...props }: MessageToolbarProps) => (
...
export const MessageBranchSelector = withProGuard(
	MessageBranchSelectorBase,
	"MessageBranchSelector"
)

export const MessageBranchPrevious = withProGuard(
	MessageBranchPreviousBase,
