...
| DataTable | `@blazz/ui/components/blocks/data-table` | Import from @blazz/ui/components/blocks/data-table — not from @blazz/ui |
| StatsGrid | `@blazz/ui/components/blocks/stats-grid` | Maximum 4 stats per row — beyond that the eye doesn't know where to focus |
| FilterBar | `@blazz/ui/components/blocks/filter-bar` | FilterBar goes ABOVE the DataTable, outside of it — not inside |
| DetailPanel | `@blazz/ui/components/blocks/detail-panel` | DetailPanel is a compound component — always use DetailPanel.Header and DetailPa |
| ActivityTimeline | `@blazz/ui/components/blocks/activity-timeline` | The prop is 'events', not 'activities' — the component uses TimelineEvent, not A |
...
`@blazz/ui/components/blocks/data-table`
Named: `DataTable, col`

- ⚠️ Import from @blazz/ui/components/blocks/data-table — not from @blazz/ui
...
```tsx
import { DataTable, col } from "@blazz/ui/components/blocks/data-table"
...
`@blazz/ui/components/blocks/stats-grid`
Named: `StatsGrid`
...
`@blazz/ui/components/blocks/filter-bar`
Named: `FilterBar`
...
`@blazz/ui/components/blocks/detail-panel`
Named: `DetailPanel`
...
`@blazz/ui/components/blocks/activity-timeline`
