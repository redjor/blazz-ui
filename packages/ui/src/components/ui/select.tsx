	...
	return (
		...
		>
			...
			<SelectPrimitive.Icon
				render={<ChevronDownIcon className="text-fg-muted size-4 pointer-events-none" />}
			/>
		</SelectPrimitive.Trigger>
	)
}
...
function SelectLabel({ className, ...props }: SelectPrimitive.GroupLabel.Props) {
	return (
		<SelectPrimitive.GroupLabel
			...
			className={cn("text-fg-muted px-1.5 py-1 text-xs", className)}
			{...props}
		/>
	)
}
...
function SelectSeparator({ className, ...props }: SelectPrimitive.Separator.Props) {
	return (
		<SelectPrimitive.Separator
			...
			className={cn("bg-edge -mx-1 my-1 h-px pointer-events-none", className)}
			{...props}
		/>
	)
}
...
function SelectScrollUpButton({
	...
	return (
		<SelectPrimitive.ScrollUpArrow
			...
			className={cn(
				"bg-panel z-10 flex cursor-default items-center justify-center py-1 [&_svg:not([class*='size-'])]:size-4 top-0 w-full",
				className
			)}
			{...props}
		>
...
function SelectScrollDownButton({
	...
	return (
		<SelectPrimitive.ScrollDownArrow
			...
			className={cn(
				"bg-panel z-10 flex cursor-default items-center justify-center py-1 [&_svg:not([class*='size-'])]:size-4 bottom-0 w-full",
				className
			)}
			{...props}
		>
