	...
	return (
		<Popover open={open} onOpenChange={setOpen}>
			{iconTrigger ? (
				<PopoverTrigger
					className={cn(
						"focus-visible:border-brand focus-visible:ring-brand/20 border-field bg-card hover:bg-muted hover:text-fg aria-expanded:bg-muted aria-expanded:text-fg rounded-lg border bg-clip-padding focus-visible:ring-[3px] inline-flex items-center justify-center transition-all disabled:pointer-events-none disabled:opacity-50 shrink-0 outline-none select-none size-8",
						className
					)}
					role="combobox"
					aria-expanded={open}
				...
				<PopoverTrigger
					className={cn(
						"focus-visible:border-brand focus-visible:ring-brand/20 border-field bg-card hover:bg-muted hover:text-fg aria-expanded:bg-muted aria-expanded:text-fg rounded-lg border bg-clip-padding text-sm font-medium focus-visible:ring-[3px] inline-flex items-center justify-between whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-50 shrink-0 outline-none select-none gap-1.5 px-2.5 w-full",
