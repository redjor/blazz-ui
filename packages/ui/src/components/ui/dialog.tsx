	...
	return (
		<DialogPortal>
			...
			<DialogPrimitive.Popup
				...
				className={cn(
					"bg-panel data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 ring-edge/40 grid max-w-[calc(100%-2rem)] gap-4 rounded-xl text-sm ring-1 duration-100 fixed top-1/2 left-1/2 z-50 w-full -translate-x-1/2 -translate-y-1/2 outline-none",
