...
const Table = React.forwardRef<HTMLTableElement, React.HTMLAttributes<HTMLTableElement> & { density?: TableDensity; wrapperClassName?: string }>(
	({ className, density = "default", wrapperClassName, ...props }, ref) => (
		<div className={cn("relative w-full overflow-auto", wrapperClassName)}>
			<table ref={ref} data-slot="table" data-density={density} className={cn("w-full caption-bottom text-xs", className)} {...props} />
		</div>
	)
)
...
const TableRow = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(({ className, ...props }, ref) => (
	<tr ref={ref} data-slot="table-row" className={cn("border-b border-separator transition-colors hover:bg-muted/50 data-[state=selected]:bg-brand/5", className)} {...props} />
))
...
const TableCaption = React.forwardRef<HTMLTableCaptionElement, React.HTMLAttributes<HTMLTableCaptionElement>>(({ className, ...props }, ref) => (
	<caption ref={ref} data-slot="table-caption" className={cn("mt-4 text-sm text-fg-muted", className)} {...props} />
))
