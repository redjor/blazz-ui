...
const ConversationContentBase = ({ className, ...props }: ConversationContentProps) => (
...
const ConversationScrollButtonBase = ({ className, ...props }: ConversationScrollButtonProps) => {
...
export const ConversationEmptyState = withProGuard(
	ConversationEmptyStateBase,
	"ConversationEmptyState"
)

export const ConversationScrollButton = withProGuard(
	ConversationScrollButtonBase,
