...
const AttachmentsBase = ({ variant = "grid", className, children, ...props }: AttachmentsProps) => {
...
const AttachmentBase = ({ data, onRemove, className, children, ...props }: AttachmentProps) => {
...
const AttachmentPreviewBase = ({ fallbackIcon, className, ...props }: AttachmentPreviewProps) => {
...
const AttachmentHoverCardTriggerBase = (props: AttachmentHoverCardTriggerProps) => (
...
const AttachmentEmptyBase = ({ className, children, ...props }: AttachmentEmptyProps) => (
	<div
...
export const AttachmentHoverCardTrigger = withProGuard(
	AttachmentHoverCardTriggerBase,
	"AttachmentHoverCardTrigger"
)

export const AttachmentHoverCardContent = withProGuard(
	AttachmentHoverCardContentBase,
