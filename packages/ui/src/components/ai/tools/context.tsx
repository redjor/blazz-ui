...
const ContextBase = ({ usedTokens, maxTokens, usage, modelId, ...props }: ContextProps) => {
...
const ContextContentBase = ({ className, ...props }: ContextContentProps) => (
	<HoverCardContent className={cn("min-w-60 divide-y overflow-hidden p-0", className)} {...props} />
)

export type ContextContentHeaderProps = ComponentProps<"div">

const ContextContentHeaderBase = ({ children, className, ...props }: ContextContentHeaderProps) => {
	const { usedTokens, maxTokens } = useContextValue()
	const usedPercent = usedTokens / maxTokens
...
const ContextContentBodyBase = ({ children, className, ...props }: ContextContentBodyProps) => (
...
const ContextContentFooterBase = ({ children, className, ...props }: ContextContentFooterProps) => {
...
const ContextInputUsageBase = ({ className, children, ...props }: ContextInputUsageProps) => {
...
const ContextOutputUsageBase = ({ className, children, ...props }: ContextOutputUsageProps) => {
	const { usage, modelId } = useContextValue()
...
const ContextCacheUsageBase = ({ className, children, ...props }: ContextCacheUsageProps) => {
	const { usage, modelId } = useContextValue()
...
export const ContextReasoningUsage = withProGuard(
	ContextReasoningUsageBase,
