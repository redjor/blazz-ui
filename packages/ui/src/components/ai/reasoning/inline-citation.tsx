...
const InlineCitationBase = ({ className, ...props }: InlineCitationProps) => (
	<span className={cn("group inline items-center gap-1", className)} {...props} />
)

export type InlineCitationTextProps = ComponentProps<"span">

const InlineCitationTextBase = ({ className, ...props }: InlineCitationTextProps) => (
...
const InlineCitationCardBodyBase = ({ className, ...props }: InlineCitationCardBodyProps) => (
...
const InlineCitationCarouselContentBase = (props: InlineCitationCarouselContentProps) => (
...
const InlineCitationQuoteBase = ({ children, className, ...props }: InlineCitationQuoteProps) => (
	<blockquote
...
export const InlineCitationCardTrigger = withProGuard(
	InlineCitationCardTriggerBase,
	"InlineCitationCardTrigger"
)

export const InlineCitationCardBody = withProGuard(
	InlineCitationCardBodyBase,
	"InlineCitationCardBody"
)

export const InlineCitationCarousel = withProGuard(
	InlineCitationCarouselBase,
	"InlineCitationCarousel"
)

export const InlineCitationCarouselContent = withProGuard(
	InlineCitationCarouselContentBase,
	"InlineCitationCarouselContent"
)

export const InlineCitationCarouselItem = withProGuard(
	InlineCitationCarouselItemBase,
	"InlineCitationCarouselItem"
)

export const InlineCitationCarouselHeader = withProGuard(
	InlineCitationCarouselHeaderBase,
	"InlineCitationCarouselHeader"
)

export const InlineCitationCarouselIndex = withProGuard(
	InlineCitationCarouselIndexBase,
	"InlineCitationCarouselIndex"
)

export const InlineCitationCarouselPrev = withProGuard(
	InlineCitationCarouselPrevBase,
	"InlineCitationCarouselPrev"
)

export const InlineCitationCarouselNext = withProGuard(
	InlineCitationCarouselNextBase,
