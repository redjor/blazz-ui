  ...
  <NotificationList>
    ...
    <NotificationGroup label="Earlier">
      ...
      <NotificationItem notification={...} />
				...
				<DocExample
					title="With Actions"
					description='Notifications can include primary actions (inline links) and secondary actions (dropdown menu on hover). Use variant: "primary" for the main action.'
    ...
    >
      <NotificationList>
        ...
        />
			...
			<DocSection
				id="notification-item-props"
				title="NotificationItem Props"
			>
			...
			<DocSection id="best-practices" title="Best Practices">
				<ul className="list-disc list-inside space-y-2 text-fg-muted">
					<li>
						Use NotificationGroup to organize notifications by time
						period
					</li>
					<li>Keep action labels short (1-2 words)</li>
					<li>
						Use <code className="text-xs">variant: "primary"</code>{" "}
						for the main action only
					</li>
					<li>
						Use iconVariant to convey notification intent at a
						glance
					</li>
					...
					items={[
						{
							...
							description:
								"Slide-in panel container for notifications.",
						},
						{
							title: "Badge",
						...
						},
						{
							...
							description:
								"Powers secondary actions on notification items.",
						},
					]}
				/>
			</DocSection>
