        ...
        <Card className="border-primary/20 bg-primary/5">
          ...
          <CardContent className="space-y-4">
            <p className="text-body-md text-muted-foreground">
              Navigation avec sidebar officielle ShadCn, menus imbriqués, breadcrumbs dynamiques,
              et palette de commandes (Cmd+K). Design sage green inspiré de Shopify.
            </p>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Exemples de composants disponibles dans le package
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-body-md text-muted-foreground">
                Ce package contient des composants UI basés sur <strong>Base UI</strong> (la nouvelle architecture de shadcn),
                un système de layout, et des utilities complètes.
              </p>
              <div className="space-y-2">
