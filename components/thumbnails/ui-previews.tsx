...
import { NavMenu, NavMenuGroup, NavMenuItem } from "@/components/ui/nav-menu"
import {
  Frame,
  FramePanel,
  FrameHeader,
  ...
  return (
    <div className="flex flex-col gap-4 p-8">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Badge variant="critical" dot>Overdue</Badge>
...
export function TextPreview() {
  return (
    <div className="flex flex-col gap-3 p-8 w-[480px]">
      ...
      <Text variant="body-sm" tone="muted">Body small with muted tone.</Text>
      <Text variant="body-xs" tone="subtle">Body XS with subtle tone.</Text>
    </div>
  )
}
    ...
    <div className="flex flex-col gap-4 p-8 w-[480px]">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-1">
          <Text variant="body-xs" tone="muted">CellUser</Text>
          <div className="flex items-center gap-2">
            <Avatar size="sm"><AvatarFallback>JD</AvatarFallback></Avatar>
            <div>
              <Text variant="body-sm">John Doe</Text>
              <Text variant="body-xs" tone="muted">Engineering</Text>
            </div>
          </div>
        </div>
        <div className="space-y-1">
          <Text variant="body-xs" tone="muted">CellTags</Text>
          <div className="flex gap-1">
            <Badge size="xs" variant="info">React</Badge>
            <Badge size="xs" variant="success">TypeScript</Badge>
            <Badge size="xs" variant="outline">+2</Badge>
          </div>
        </div>
        <div className="space-y-1">
          <Text variant="body-xs" tone="muted">CellProgress</Text>
          <div className="flex items-center gap-2">
            <div className="h-1.5 w-24 rounded-full bg-raised overflow-hidden">
              <div className="h-full w-3/4 rounded-full bg-brand" />
            </div>
            <Text variant="body-xs" tone="muted">75%</Text>
          </div>
        </div>
        <div className="space-y-1">
          <Text variant="body-xs" tone="muted">CellRating</Text>
        ...
        <div className="space-y-1">
          <Text variant="body-xs" tone="muted">CellBoolean</Text>
        ...
        <div className="space-y-1">
          <Text variant="body-xs" tone="muted">CellColorDot</Text>
    ...
    <div className="flex flex-col gap-6 p-8 w-[480px]">
      <Tabs defaultValue="overview">
        ...
        <TabsContent value="overview">
          <div className="rounded-lg border border-edge p-4">
            <Text variant="body-md" tone="muted">Overview tab content goes here.</Text>
          </div>
        </TabsContent>
      </Tabs>
      <Tabs defaultValue="general">
        ...
        <TabsContent value="general">
          <div className="rounded-lg border border-edge p-4">
            <Text variant="body-md" tone="muted">Line variant tab content.</Text>
          </div>
        </TabsContent>
      </Tabs>
    </div>
    ...
    <div className="p-8 w-[480px]">
      <Frame>
        ...
        <FramePanel>
          ...
          <div className="p-4">
            <Text variant="body-sm" tone="muted">No recent activity.</Text>
          </div>
        </FramePanel>
      </Frame>
    </div>
...
export function DialogPreview() {
  return (
    <div className="p-8 w-[480px]">
      <div className="rounded-xl border border-edge bg-panel p-4 shadow-lg ring-1 ring-edge/40">
        ...
        <div className="-mx-4 -mb-4 mt-4 flex justify-end gap-2 rounded-b-xl border-t border-edge bg-raised p-4">
          <Button variant="outline">Cancel</Button>
...
export function SheetPreview() {
  return (
    <div className="p-8 w-[400px]">
      <div className="flex h-[320px] flex-col rounded-xl border border-edge bg-panel shadow-lg overflow-hidden">
        ...
        <div className="flex justify-end gap-2 border-t border-edge bg-raised px-4 py-3">
...
export function DropdownMenuPreview() {
  return (
    <div className="p-8 w-[280px]">
      <div className="rounded-lg border bg-panel p-1 shadow-md ring-1 ring-fg/10">
        <div className="px-1.5 py-1 text-xs font-medium text-fg-muted">Actions</div>
        <div className="flex cursor-default items-center gap-1.5 rounded-md bg-raised px-1.5 py-1 text-sm text-fg">
...
export function PopoverPreview() {
  return (
    <div className="p-8 w-[340px]">
      <div className="rounded-lg border bg-panel p-2.5 shadow-md ring-1 ring-edge/40">
...
export function MenuPreview() {
  return (
    <div className="p-8 w-[240px]">
      <div className="rounded-md border bg-panel p-1 shadow-md">
        <div className="flex cursor-default items-center rounded-sm bg-raised px-2 py-1.5 text-sm text-fg">
...
export function CommandPreview() {
  return (
    <div className="p-8 w-[480px]">
      <div className="rounded-lg border bg-panel shadow-lg overflow-hidden">
        ...
        <div className="p-1">
          ...
          <div className="flex items-center gap-2 rounded-sm bg-raised px-2 py-1.5 text-sm text-fg">
      ...
      <div className="rounded-xl border border-edge bg-panel p-4 shadow-lg ring-1 ring-edge/40">
        <div className="-mx-4 -mt-4 flex flex-col gap-2 px-4 pb-3 pt-4">
          ...
          <div className="text-sm text-fg-muted">
            This action cannot be undone. The deal and all associated data will be permanently removed from your workspace.
          </div>
        </div>
        <div className="-mx-4 -mb-4 mt-4 flex justify-end gap-2 rounded-b-xl border-t border-edge bg-raised p-4">
          <Button variant="outline">Cancel</Button>
...
export function DataTablePreview() {
  const deals = [
    { name: "Enterprise Plan", company: "Acme Corp", value: "$85,000", stage: "Proposal", owner: "SJ" },
    { name: "Pro License x50", company: "Globex Inc", value: "$42,000", stage: "Negotiation", owner: "JC" },
    { name: "Annual Renewal", company: "Initech", value: "$28,500", stage: "Closed Won", owner: "MS" },
    { name: "Custom Integration", company: "Umbrella Co", value: "$120,000", stage: "Discovery", owner: "AW" },
      ...
      <div className="rounded-lg border border-edge overflow-hidden">
        ...
        <div className="flex items-center justify-between border-b border-edge bg-surface px-3 py-2">
          <div className="flex items-center gap-2">
            ...
            <Badge variant="secondary" size="xs">{deals.length} deals</Badge>
          </div>
          <div className="flex items-center gap-1">
          ...
          <TableBody>
            {deals.map((deal) => (
              <TableRow key={deal.name}>
                ...
                <TableCell>
                  <div className="flex items-center gap-1.5">
                    <Avatar size="sm"><AvatarFallback>{deal.owner}</AvatarFallback></Avatar>
                    {deal.company}
                  </div>
                </TableCell>
                <TableCell className="text-right tabular-nums">{deal.value}</TableCell>
                <TableCell>
                  <Badge variant={stageBadge(deal.stage)} size="xs" fill="subtle">{deal.stage}</Badge>
                </TableCell>
                <TableCell>
                  <Button variant="ghost" size="icon-xs">
                    <MoreHorizontal />
        ...
        <div className="flex items-center justify-between border-t border-edge bg-surface px-3 py-2">
          <Text variant="body-xs" tone="muted">Showing 1-5 of 24 deals</Text>
          <div className="flex items-center gap-1">
        ...
        <CardHeader>
          <CardTitle>
            <div className="flex items-center gap-2">
              ...
              Notifications
              <Badge variant="default" size="xs">2</Badge>
            </div>
          </CardTitle>
        </CardHeader>
          ...
          <div className="divide-y divide-edge">
            {notifications.map((n, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`flex gap-3 px-4 py-3 ${!n.read ? "bg-brand/5" : ""}`}
                >
                  <div
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <Text variant="body-xs" tone="muted">{n.description}</Text>
                  </div>
                  {!n.read && (
...
export function OrgMenuPreview() {
  return (
    <div className="p-8 w-[280px]">
      ...
      <div className="flex items-center gap-2 rounded-lg px-2 py-2 transition-colors hover:bg-raised">
      ...
      <div className="mt-2 rounded-lg border bg-panel p-1 shadow-md ring-1 ring-fg/10">
        <div className="px-1.5 py-1 text-xs font-medium text-fg-muted">Organizations</div>
        <div className="flex items-center gap-2 rounded-md bg-raised px-1.5 py-1 text-sm">
          ...
          <div className="flex divide-x divide-edge">
            {stats.map((stat) => (
              <div key={stat.label} className="flex flex-1 flex-col gap-1 px-4 py-3">
                <Text variant="body-xs" tone="muted">{stat.label}</Text>
                <Text variant="heading-lg" numeric>{stat.value}</Text>
              </div>
            ))}
          </div>
        </CardContent>
