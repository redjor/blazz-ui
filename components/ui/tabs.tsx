...
const tabsListVariants = cva(
	"rounded-lg p-[3px] group-data-horizontal/tabs:h-8 data-[variant=line]:rounded-none group/tabs-list text-fg-muted inline-flex w-fit items-center justify-center group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col",
	{
		variants: {
			variant: {
				default: "bg-raised",
	...
	return (
		<TabsPrimitive.Tab
			...
			className={cn(
				...
				"focus-visible:border-brand focus-visible:ring-brand/20 focus-visible:ring-[3px] focus-visible:outline-1",
				...
				"after:bg-fg after:absolute after:opacity-0 after:transition-opacity",
