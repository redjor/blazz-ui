...
/**
 * Evaluate a single filter condition directly against a data item.
...
/**
 * Create a filter function that operates directly on data items (TData)
 * instead of TanStack Table Row objects. This avoids creating fake Row
 * instances for client-side filtering.
 *
 ...
 */
export function getCurrentFilterValue(filterGroup: FilterGroup | null, columnKey: string): any {
