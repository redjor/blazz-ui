...
export function AppTopBar({ onOpenCommandPalette, className }: AppTopBarProps) {
  return (
    <header className={cn('flex h-[56px] shrink-0 items-center justify-between border-b border-gray-800 bg-black px-4', className)}>
      {/* Left: Logo + App Name */}
      ...
      >
        ...
        <kbd className="ml-auto hidden rounded border border-gray-700 bg-gray-700 px-1.5 py-0.5 text-xs text-gray-300 md:inline-flex">⌘K</kbd>
      </button>
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="flex items-center gap-2 rounded-lg px-2 py-1.5 transition-colors hover:bg-gray-800">
