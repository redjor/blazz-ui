...
import { useFrame, type BreadcrumbItem as BreadcrumbItemType } from './frame-context'
 ...
 * />
 */
export function TopBar({ breadcrumbs: propBreadcrumbs, actions, title, className, onToggleSidebar }: TopBarProps) {
  ...
  return (
    <header className={cn('flex h-14 shrink-0 items-center gap-4 border-b border-gray-200 bg-white px-6 shadow-sm', className)}>
