...
export function Frame({
  ...
  return (
    ...
    >
      ...
      <div className="[grid-area:topbar] z-20">
        {topBar}
      </div>

      {/* Navigation - Left sidebar */}
      <div className="[grid-area:nav] z-10 overflow-y-auto rounded-tl-lg">
        {navigation}
      </div>

      {/* Main Content - Scrollable area */}
      <main className="[grid-area:main] overflow-y-auto rounded-tr-lg" style={{ backgroundColor: '#f1f1f1' }}>
        {children}
      </main>
    </div>
  )
